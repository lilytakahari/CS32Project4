...
using namespace std;
 ...
 int main()
 {
    ...
    testResult = test.find("hit", false);
...
//    cerr << endl;
//    cerr << "we okay" << endl;
//    ifstream test("/Users/ltakahari/Documents/Winter_2019/CS_32/project4/project4/test.txt");
//    if (!test)
//    {
//        cerr << "file not loaded properly" << endl;
//        return 9;
//    }
////    string bitch;
////    vector<Genome> testV;
////    bool check = Genome::load(test, testV);
////    cerr << check << endl;
////    for (int i = 0; i < testV.size(); i++)
////    {
////        cerr << testV[i].extract(4, 1, bitch) << endl;
////        cerr << bitch << endl;
////    }
//
//
...
//
//const string PROVIDED_DIR = "/Users/ltakahari/Documents/Winter_2019/CS_32/project4/project4/Gee-nomics/data";
//
